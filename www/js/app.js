...
angular.module('starter', ['ionic', 'ngResource', 'pascalprecht.translate', 'ngMap', 'starter.controllers', 'starter.services', 'ionic-datepicker', 'chart.js'])
    ...
    $stateProvider
            ...
            .state('app.autresprix', {
                url: '/playlist/:idProduit/:idVille',
                views: {
                    'menuContent': {
                        templateUrl: 'templates/prixautresmarches.html',
                        controller: 'AutresprixCtrl'
                    }
                }
            })
            .state('app.single', {
                url: '/playlists/:idProduit/:idmarche/:idVille',
                views: {
                    'menuContent': {
